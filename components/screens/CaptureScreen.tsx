  ...
  return (
    <div className="screen items-center gap-5 py-8">
      ...
      <div className="flex items-start justify-between w-full">
        ...
        <button
          className="font-sans text-[10px] text-graphite/30 tracking-widest uppercase hover:text-graphite/50 transition-colors mt-1 flex-shrink-0"
        ...
        <div className="absolute inset-1 overflow-hidden bg-slate/5 rounded-xl">
          ...
          {error && (
            <div className="absolute inset-0 flex items-center justify-center p-6 bg-ivory/90">
              <p className="font-sans text-[11px] text-graphite/50 text-center">{error}</p>
            </div>
          )}
          ...
          {!isActive && !error && (
            <div className="absolute inset-0 flex items-center justify-center">
              <motion.p
                ...
                className="font-sans text-[11px] text-teal/50 tracking-widest uppercase"
              >
                Initialising...
              </motion.p>
            </div>
